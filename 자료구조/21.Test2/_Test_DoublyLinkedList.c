...
Node* SequentialSearch(Node* Head, double targetvalue)
{
    while (Head != NULL)
    {
        if (Head->Data.score == targetvalue)
            return Head;
...
Node* MoveToFront(Node** Head, double targetvalue)
{
    ...
    while (NewData != NULL)
    {
        if (NewData->Data.score == targetvalue)
        {
            if (NewData->PrevNode != NULL)
            {
                NewData->PrevNode->NextNode = NewData->NextNode;

                if(NewData->NextNode != NULL)
                    NewData->NextNode->PrevNode = NewData->PrevNode;
        ...
        if (NewData->NextNode == NULL) break;

        NewData = NewData->NextNode;
    }
...
Node* Transpose(Node** Head, double targetvalue)
{
    ...
    while (NewData != NULL)
    {
        if (NewData->Data.score == targetvalue)
        {
            if (NewData->PrevNode != NULL)
            {
                //if (NewData->PrevNode->PrevNode != NULL)
                //    NewData->PrevNode->PrevNode = NewData;
                //else
                //    *Head = NewData;
                ...
                //NewData->NextNode = NewData->PrevNode;


                NewData->PrevNode->NextNode = NewData->NextNode;

                NewData->PrevNode = NewData->PrevNode->PrevNode;
                NewData->PrevNode->NextNode = NewData;
