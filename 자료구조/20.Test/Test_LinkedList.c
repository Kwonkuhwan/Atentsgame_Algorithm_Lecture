...
Node* MoveToFront(Node** Head, double targetvalue) 
{
    ...
    while (NewData != NULL)
    {
        if (NewData->Data.score == targetvalue)
        {
            if (PrevData != NULL) 
            {
                PrevData->NextNode = NewData->NextNode;
...
Node* Transpose(Node** Head, double targetvalue) 
{
    ...
    while (NewData != NULL)
    {
        if (NewData->Data.score == targetvalue)
        {
            if (PrevData != NULL)
            {
                if (Old_PrevData != NULL)
                    Old_PrevData->NextNode = NewData;
                else
                    *Head = NewData;

                PrevData->NextNode = NewData->NextNode;
                NewData->NextNode = PrevData;
            }
            return *Head;
        }

        if (PrevData != NULL)
            Old_PrevData = PrevData;
...
Node* weight(Node** Head, double targetvalue) 
{
